    ...
    return (
        <div className='relative flex items-center justify-center h-screen overflow-hidden'>
            ...
            <div className='absolute top-4 md:top-8 left-2 md:left-6'>
                <Image src='/logo.png' height={45} width={162} alt='brand-logo' />
            </div>
            ...
            <div className='mid-content space-y-8 h-screen flex flex-col justify-center items-center z-20 px-6 md:px-1'>
                ...
                <button className='font-poppins rounded-md px-3 py-4 bg-white font-bold tracking-widest text-xl text-black w-40 md:w-60'>Login</button>
            </div>
